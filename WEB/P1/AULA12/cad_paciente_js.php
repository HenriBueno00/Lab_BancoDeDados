...
<head>
    ...
    function addTelefone () {
        ...
        var divTelefones = document.getElementById("telefones");
        var inputs = divTelefones.getElementsByTagName("input");
        if (inputs.length > 1) { // Garante que haja pelo menos um campo de telefone
            divTelefones.removeChild(inputs[inputs.length - 1]);
        }
    }
...
<body>
    ...
    ?>
    <form action="inc_paci_2.php" method="post">
        <table width="100%">
            <tr>
        ...
        <fieldset>
            ...
            <div id="telefones">
                ...
                <input type="tel" name="telefones []" placeholder=" (XX) XXXXX-XXXX"><br> 
            </div>
            <button type="button" onclick="addTelefone ()">Adicionar Telefone</button>
            <button type="button" onclick="removeTelefone()">Remover Telefone</button>
        </fieldset>
